## Purpose
Defines the architectural and structural packaging organization rules for the Better Mind Maps codebase to ensure a clean Model-View-Controller pattern separation.
